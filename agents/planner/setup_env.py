...
def create_env_file(env_vars: Dict[str, str]):
    ...
    with open(env_file, 'w') as f:
        ...
        f.write(f"RABBITMQ_URL={existing_vars.get('RABBITMQ_URL', 'amqp://guest:guest@localhost:5672/')}\n")
        ...
        f.write(f"CHROMADB_URL={existing_vars.get('CHROMADB_URL', 'http://localhost:8000')}\n")
...
def check_services():
    ...
    services = [
        ...
        ("ChromaDB (Vector DB)", "http://localhost:8000/api/v1/heartbeat"),
